      ...
      <div className="relative mx-auto max-w-7xl px-6 py-8">
        <header className="sticky top-6 z-50 flex items-center justify-between rounded-[28px] border border-black/[0.03] bg-white/80 p-3 shadow-sm backdrop-blur-xl">
          <div className="flex items-center gap-6">
            <Link href="/admin" className="flex items-center gap-3 pl-3 transition-transform hover:scale-105 active:scale-95">
              <div className="relative w-20 h-10 flex items-center justify-center">
                <Image src="/logo.svg" alt="Lyxaa" width={80} height={40} className="object-contain" />
              </div>
            </Link>
